...
//   },
//   {
//     id: "731157387456741969534323dfgssd",
...
//   },
//   {
//     id: "7311576497869979412mebuzpq333",
//     name: "Лидерская пятница. Тема уточняется",
//     local_time_string: "мск",
//     max_pers: 992,
//     is_open: 1,
...
//     finish_date: "2024-01-23T10:00:00+00:00",
//     is_passed: 0,
//     company: "ПРОВАЙДЕР",
//     Mandatorys: "0",
//   },
...
//   },
//   {
//     id: "731441578236497869sdfs979412d2ss13weadd",
//     name: "long multiweek event",
//     local_time_string: "мск",
//     max_pers: 992,
//     is_open: 1,
//     registred: 0,
...
//   },
//   {
//     id: "731441578236497869sdfs979412d2ss13weaddhello1",
//     name: "Навыки комуникации",
//     local_time_string: "мск",
//     max_pers: 992,
//     is_open: 1,
//     registred: 0,
...
//     finish_date: "2024-02-17T10:00:00+00:00",
//     is_passed: 0,
//     company: "ПРОВАЙДЕР",
//     Mandatorys: "0",
//   },
//   {
//     id: "731441578236497869sdfs979412d2ss13weaddhello2",
//     name: "Навыки комуникации",
//     local_time_string: "мск",
//     max_pers: 992,
//     is_open: 1,
...
//     type_val:
//       "fa-heart][Вовлеченность;fa-lightbulb][Командный br дух;fa-user][Клиент;fa-handshake][Инновации;fa-check-circle][Ответственность",
...
//     event_rb_type:
//       "all][Общебанковские тренинги;prof][Профессиональное обучение",
...
//     type_val:
//       "fa-heart][Вовлеченность;fa-handshake][Инновации;fa-user][Клиент;fa-lightbulb][Командный br дух;fa-check-circle][Ответственность",
...
//     description:
//       "<p>Приглашаем вас на встречу в рамках проекта &quot;Лидерская пятница&quot;.</p><p>Детали подключения будут направлены после регистрации.</p>",
...
//     type_val:
//       "fa-heart][Вовлеченность;fa-lightbulb][Командный br дух;fa-handshake][Инновации",
...
//     type_val:
//       "fa-lightbulb][Командный br дух;fa-heart][Вовлеченность;fa-handshake][Инновации;fa-user][Клиент;fa-check-circle][Ответственность",
...
//     type_val:
//       "fa-lightbulb][Командный br дух;fa-handshake][Инновации;fa-user][Клиент;fa-heart][Вовлеченность;fa-check-circle][Ответственность",
...
//     type_val:
//       "fa-heart][Вовлеченность;fa-lightbulb][Командный br дух;fa-check-circle][Ответственность;fa-user][Клиент;fa-handshake][Инновации",
...
//     start_date: "2024-01-24T13:00:00+00:00",

//     finish_date: "2024-01-24T15:30:00+00:00",
...
//     type_val:
//       "fa-heart][Вовлеченность;fa-user][Клиент;fa-check-circle][Ответственность",
...
//     type_val:
//       "fa-heart][Вовлеченность;fa-user][Клиент;fa-handshake][Инновации;fa-check-circle][Ответственность",
...
//     type_val:
//       "fa-lightbulb][Командный br дух;fa-user][Клиент;fa-heart][Вовлеченность;fa-check-circle][Ответственность",
...
//     type_val:
//       "fa-check-circle][Ответственность;fa-heart][Вовлеченность;fa-user][Клиент;fa-handshake][Инновации",
...
//     type_val:
//       "fa-heart][Вовлеченность;fa-check-circle][Ответственность;fa-user][Клиент",
...
//     type_val:
//       "fa-heart][Вовлеченность;fa-lightbulb][Командный br дух;fa-user][Клиент;fa-check-circle][Ответственность",
...
//     type_val:
//       "fa-heart][Вовлеченность;fa-lightbulb][Командный br дух;fa-user][Клиент;fa-check-circle][Ответственность;fa-handshake][Инновации",
...
//     type_val:
//       "fa-heart][Вовлеченность;fa-user][Клиент;fa-check-circle][Ответственность;fa-lightbulb][Командный br дух;fa-handshake][Инновации",
...
//     type_val:
//       "fa-lightbulb][Командный br дух;fa-heart][Вовлеченность;fa-check-circle][Ответственность",
...
//     type_val:
//       "fa-lightbulb][Командный br дух;fa-heart][Вовлеченность;fa-user][Клиент;fa-check-circle][Ответственность",
...
//     description:
//       "<p><span style='font-family:arial,helvetica,sans-serif'><span style='font-family:arial,helvetica,sans-serif'>Представьте, что у вас есть отличная идея, которая решит реальную проблему. Осталось убедить в этом окружающих, чтобы ее реализовать.</span></span></p><p><span style='font-family:arial,helvetica,sans-serif'>Как это сделать? Как представить свою идею и получить заветное &laquo;ДА&raquo;? Здесь помогут техники и алгоритмы питчинга.</span></p><p><span style='font-family:arial,helvetica,sans-serif'><strong>На вебинаре&nbsp;вы узнаете:</strong></span></p><ul><li><span style='font-family:arial,helvetica,sans-serif'>Что такое питчинг и как к нему готовиться</span></li><li><span style='font-family:arial,helvetica,sans-serif'>Один из базовых алгоритмов питча</span></li></ul><p><strong><span style='font-family:arial,helvetica,sans-serif'>И потренируетесь:</span></strong></p><ul><li><span style='font-family:arial,helvetica,sans-serif'>Делать короткое выступление на основе алгоритма</span></li></ul>",
